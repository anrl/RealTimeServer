...
int *imageSize = new int[GROUP_SIZE];
...
//		cout<<"transfer size "<<libwebsocket_write(wsi, imageBuf, buffSize, LWS_WRITE_BINARY)<<endl;
		libwebsocket_write(wsi, &imageBuf[pos[wsi->sock%GROUP_SIZE]], imageSize[id%GROUP_SIZE], LWS_WRITE_BINARY);
